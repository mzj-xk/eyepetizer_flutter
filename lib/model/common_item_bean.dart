import 'package:eyepetizer_flutter/model/base_item_bean.dart';

class CommonItemBean extends BaseItemBean<Item> {
  int total;
  int date;
  int publishTime;
  int releaseTime;
  ...
  CommonItemBean.fromJson(Map<String, dynamic> json) {
    total = json['total'];
    date = json['date'];
